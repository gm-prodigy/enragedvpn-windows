...
namespace Tunnel
{
    ...
    {
        private const string LongName = "enragedvpn service";
        private const string Description = "EnragedVPN Tunnel Service";
        ...
        public static void Add(string configFile, bool ephemeral)
        {
            ...
            var pathAndArgs = String.Format("\"{0}\" /service \"{1}\" {2}", exeName, configFile, Environment.ProcessId); //TODO: This is not the proper way to escape file args.
